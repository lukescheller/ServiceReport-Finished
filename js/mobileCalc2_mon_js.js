let ls = localStorage;
// ls.setItem('Wed Apr 24 2018 22:48:55 GMT-0700 (PDT)','{"date":"Wed Apr 22 2018 22:48:55 GMT-0700 (PDT)","tip_amount_num":127.45,"tip_amount_string":"127.45","clockIn_hour_string":"12","clockIn_hour_number":12,"clockIn_min_string":"00","clockIn_min_number":0,"clockIn_ampm":"Pm","clockIn_as_whole":"12:00 Pm","overnight":"No","clockOut_hour_string":"05","clockOut_hour_number":17,"clockOut_min_string":"35","clockOut_min_number":35,"clockOut_ampm":"Pm","clockOut_as_whole":"05:35 Pm","shift_length":5.579999999999998,"hourly_wage_dollar_val":"8.25","hourly_wage_dollar_num":8.25,"tips_per_hour":22.840501792114704,"hourly_x_shift":46.03499999999998,"tips_hourly_shift":31.0905017921147,"over_under":"No","comment":"Good Day."}')
// ls.removeItem('Wed Apr 22 2018 22:48:55 GMT-0700 (PDT)');
// ls.clear();
console.log(ls);
//Begin Monday////////////////////////////////////////////

let tips_group_mon   = []; //needs to be completely out of the localstorage loop
let tip_sum_mon;
let tips_group_mon2 = [];
let tip_sum_mon2;
let tips_group_mon3 = [];
...
if(key.includes('Mon')){
		...
		let atps = document.getElementById('mn_avr_tps');
		atps.innerHTML 	= averageFinder(json2.tip_amount_num,tips_group_mon,tip_sum_mon);

		//average shift length
		let asl = document.getElementById('mn_avr_shift');
		asl.innerHTML 	= averageFinder(json2.shift_length,tips_group_mon2,tip_sum_mon2);

		//average tips per hour
		let atph = document.getElementById('mn_avr_tph');
		atph.innerHTML 	= averageFinder(json2.tips_per_hour,tips_group_mon3,tip_sum_mon3);

		//average tips with hourly
		let ahw = document.getElementById('mn_avr_hourly');
		ahw.innerHTML 	= averageFinder(json2.tips_hourly_shift,tips_group_mon4,tip_sum_mon4);
		...
		//sum of tips
		let ts 			= document.getElementById('mn_tip_sum');
		ts.innerHTML 	= sumFinder(json2.tip_amount_num,tips_group_mon5,tip_sum_mon5);

		//get entries box in html
		let entry_main_container 	= document.getElementById('mon_indv_entry_div');
		entry_main_container.style.border = 'none';
		...
		entry_div.style.backgroundColor = 'white';
		entry_div.style.borderRadius = '5px';
		...
		entry_date.style.borderRadius = '5px';
		...
		entry_tips.style.border 	= '1px solid none';
		...
		entry_clockIn.style.border 		= '1px solid none';
		...
		entry_clockOut.style.border 	= '1px solid none';
		...
		entry_shiftLength.style.border 		= '1px solid none';
		...
		entry_tipsPhour.style.border 		= '1px solid none';
		...
		entry_hourlyWtips.style.border 		= '1px solid none';
		...
		entry_comment.style.border 			= '1px solid none';
		...
		entry_box.style.borderRadius 	= '5px';
		...
		entry_edit.addEventListener('click',function(){
			...
			// edit_input_div.style.border 		= '1px solid white';
			...
			// edit_clockin_div.style.border 			= '1px solid white';
			...
			// edit_overnight_div.style.border 	= '1px solid white';
			...
			// edit_clockout_div.style.border 			= '1px solid white';
